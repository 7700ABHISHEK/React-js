                    ...
                    <div className="footer-1 my-5">
                        <div>
                            ...
                            <ul className='p-0 social-media-icon d-flex gap-2'>
                                <li className='rounded-circle border border-black py-2 px-3'><i class="fa-brands fa-facebook-f"></i></li>
                                <li className='rounded-circle border border-black py-2 px-3'><i class="fa-brands fa-google-plus-g"></i></li>
                                <li className='rounded-circle border border-black py-2 px-3'><i class="fa-brands fa-twitter"></i></li>
                                <li className='rounded-circle border border-black py-2 px-3'><i class="fa-brands fa-youtube"></i></li>
                                <li className='rounded-circle border border-black py-2 px-3'><i class="fa-brands fa-skype"></i></li>
                            </ul>
                            <hr />
